...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Subscribe now to receive the latest updates and news about our AI phone agent solutions.
       Be the first to know about new features, special offers, and exciting developments.
       Subscribe now to receive the latest updates and news about our AI phone agent solutions.
      </p>
      <div>
        <input
